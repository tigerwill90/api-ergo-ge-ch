...
-- Sat 18 May 2019 04:12:29 PM CEST
...
-- -----------------------------------------------------
-- Table `pfak_ergo`.`officesTherapists`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pfak_ergo`.`officesTherapists` ;

CREATE TABLE IF NOT EXISTS `pfak_ergo`.`officesTherapists` (
  `officesTherapists_offices_id` INT NOT NULL,
  `officesTherapists_therapists_id` INT NOT NULL,
  PRIMARY KEY (`officesTherapists_offices_id`, `officesTherapists_therapists_id`),
  INDEX `fk_offices_has_therapists_therapists1_idx` (`officesTherapists_therapists_id` ASC),
  INDEX `fk_offices_has_therapists_offices1_idx` (`officesTherapists_offices_id` ASC),
  CONSTRAINT `fk_offices_has_therapists_offices1`
    FOREIGN KEY (`officesTherapists_offices_id`)
    REFERENCES `pfak_ergo`.`offices` (`offices_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_offices_has_therapists_therapists1`
    FOREIGN KEY (`officesTherapists_therapists_id`)
    REFERENCES `pfak_ergo`.`therapists` (`therapists_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `pfak_ergo`;
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (1, 'M.', 'Octavius', 'Reyes', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (2, 'Mme.', 'Abraham', 'Reilly', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (3, 'Mme.', 'Kamal', 'West', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (4, 'M.', 'Gil', 'Greer', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (5, 'Dr.', 'Arden', 'Griffith', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (6, 'Dr.', 'Russell', 'House', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (7, 'Mme.', 'Holmes', 'Mclaughlin', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (8, 'Dr.', 'Stuart', 'Higgins', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (9, 'Dr.', 'Oscar', 'Puckett', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (10, 'Dr.', 'Damon', 'Rowe', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (11, 'Mme.', 'Ferdinand', 'Drake', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (12, 'Dr.', 'Nissim', 'Pena', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (13, 'Dr.', 'Bert', 'Hayes', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (14, 'Mme.', 'Samuel', 'Meyer', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (15, 'Mme.', 'Vladimir', 'Gardner', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (16, 'M.', 'Axel', 'Koch', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (17, 'M.', 'Odysseus', 'Bryant', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (18, 'M.', 'Clayton', 'Cardenas', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (19, 'M.', 'Joel', 'Cote', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (20, 'Dr.', 'Arden', 'Velazquez', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (21, 'Mme.', 'Dieter', 'Browning', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (22, 'Dr.', 'Odysseus', 'Blankenship', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (23, 'M.', 'Joel', 'Chang', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (24, 'Dr.', 'Alexander', 'Myers', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (25, 'M.', 'Noah', 'Oconnor', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (26, 'Mme.', 'Nathaniel', 'Mccormick', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (27, 'Dr.', 'Sylvester', 'Mendez', 1);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (28, 'Mme.', 'Kieran', 'Stephens', 0);
INSERT INTO `pfak_ergo`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`) VALUES (29, 'Dr.', 'Colt', 'Hays', 1);
...
-- -----------------------------------------------------
-- Data for table `pfak_ergo`.`officesTherapists`
-- -----------------------------------------------------
START TRANSACTION;
USE `pfak_ergo`;
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (1, 1);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (1, 2);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (1, 3);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (2, 1);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (2, 2);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (2, 3);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (3, 4);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (3, 5);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (4, 6);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (5, 6);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (5, 7);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (5, 8);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (5, 9);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (5, 10);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (6, 11);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (6, 12);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (6, 13);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (6, 14);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (7, 15);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (7, 16);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (7, 17);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (7, 18);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 18);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 19);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 20);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 21);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 22);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (8, 23);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 24);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 25);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 26);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 27);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 28);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (9, 29);
INSERT INTO `pfak_ergo`.`officesTherapists` (`officesTherapists_offices_id`, `officesTherapists_therapists_id`) VALUES (10, 29);
...
START TRANSACTION;
USE `pfak_ergo`;
INSERT INTO `pfak_ergo`.`users` (`users_id`, `users_email`, `users_hashed_password`, `users_roles`) VALUES (1, 'sylvain.muller90@gmail.com', '$2y$10$8D.Bxbi3QVjXm8QyVIkQU.', 'user');
