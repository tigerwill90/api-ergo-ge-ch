...
-- Mon 20 May 2019 11:39:49 PM CEST
...
START TRANSACTION;
USE `pfak_ergo`;
INSERT INTO `pfak_ergo`.`users` (`users_id`, `users_email`, `users_hashed_password`, `users_roles`, `users_firstname`, `users_lastname`, `users_active`, `users_cookieValue`) VALUES (1, 'sylvain.muller90@gmail.com', '$2y$10$tLVhvEYmCphDjCkGSJ52AeM07Lvy9PukdQJieS1OCZK7E3vjVEPnq', 'admin', 'Sylvain', 'Muller', 0, 'adsfasdfaf');
