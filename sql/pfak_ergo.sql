...
-- Wed 12 Jun 2019 11:01:27 PM CEST
...
START TRANSACTION;
USE `pfak_ergo`;
INSERT INTO `pfak_ergo`.`users` (`users_id`, `users_email`, `users_hashed_password`, `users_roles`, `users_firstname`, `users_lastname`, `users_active`, `users_cookieValue`, `users_created`, `users_updated`, `users_reset_jwt`) VALUES (1, 'sylvain.muller90@gmail.com', '$2y$10$tLVhvEYmCphDjCkGSJ52AeM07Lvy9PukdQJieS1OCZK7E3vjVEPnq', 'admin', 'Sylvain', 'Muller', 0, 'UPDATE COOKIE VALUE AT FIRST CONNECTION !!!', DEFAULT, DEFAULT, 'adffwqe');
INSERT INTO `pfak_ergo`.`users` (`users_id`, `users_email`, `users_hashed_password`, `users_roles`, `users_firstname`, `users_lastname`, `users_active`, `users_cookieValue`, `users_created`, `users_updated`, `users_reset_jwt`) VALUES (2, 'a@a.com', '$2y$10$tLVhvEYmCphDjCkGSJ52AeM07Lvy9PukdQJieS1OCZK7E3vjVEPnq', 'user', 'Tony', 'Stark', 1, 'afasfdasfdasf', DEFAULT, DEFAULT, 'sdfsdqweqwe');
