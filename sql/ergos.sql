...
CREATE TABLE IF NOT EXISTS `ergos`.`therapistsCategories` (
  ...
  INDEX `fk_therapists_has_categories_therapists1_idx` (`therapistsCategories_therapists_id` ASC),
  CONSTRAINT `fk_therapists_has_categories_therapists1`
    FOREIGN KEY (`therapistsCategories_therapists_id`)
    REFERENCES `ergos`.`therapists` (`therapists_offices_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
START TRANSACTION;
USE `ergos`;
INSERT INTO `ergos`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`, `therapists_offices_id`) VALUES (1, 'Mme', 'Catherine', 'DEPALLENS', DEFAULT, 1);
INSERT INTO `ergos`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`, `therapists_offices_id`) VALUES (2, 'Mme', 'Corinne', 'MASSON FRIEDLI', DEFAULT, 1);
INSERT INTO `ergos`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`, `therapists_offices_id`) VALUES (3, 'M', 'Ivo', 'CANONICA', DEFAULT, 1);
INSERT INTO `ergos`.`therapists` (`therapists_id`, `therapists_title`, `therapists_firstname`, `therapists_lastname`, `therapists_home`, `therapists_offices_id`) VALUES (4, 'Mme', 'Christelle', 'ABRIEL', DEFAULT, 2);
...
START TRANSACTION;
USE `ergos`;
INSERT INTO `ergos`.`phones` (`phones_id`, `phones_type`, `phones_numero`, `phones_therapists_id`) VALUES (1, 'tel', '0796522831', 3);
INSERT INTO `ergos`.`phones` (`phones_id`, `phones_type`, `phones_numero`, `phones_therapists_id`) VALUES (2, 'tel/fax', '0227928968', 4);
